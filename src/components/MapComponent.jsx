...
const MapComponent = () => {
  ...
  const [activePin, setActivePin] = useState(null); // Index of pin with open info window

  // List of popular UTA locations (expand as needed)
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-paw bg-repeat bg-pink-50">
      <div className="w-full flex justify-center items-center bg-gradient-to-r from-pink-700/90 to-pink-400/80 py-4 shadow-lg relative">
        ...
        <h1 className="text-white text-3xl font-bold tracking-wide drop-shadow-lg font-cursive">CatMap @ UTA</h1>
              ...
              return (
                ...
                >
                  {activePin === idx && closest && (
                    ...
                    >
                      <div className="text-xs font-cursive">
      ...
      <div className="mt-4 text-pink-700 text-base font-cursive">Click to add a cat paw, double-click a paw to remove it. Catify your campus!</div>
    </div>
  );
};
